      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { value: stats?.totalIssues || 0, label: "Issues Reported" },
              { value: stats?.resolvedIssues || 0, label: "Problems Resolved" },
              { value: stats?.totalUsers || 0, label: "Active Citizens" },
              { value: stats?.inProgressIssues || 0, label: "In Progress" },
            ].map((stat, index) => (
              <div key={index}>
